...
On macOS, [Colima](https://github.com/abiosoft/colima) works and the
framework knows about it. There is a plan step that routes the lab subnet
through the Colima VM.
