...
- A test harness for lab configurations beyond eval and lint, spinning up a
  lab in CI and asserting on live state.
...
Any of the above is a reasonable place to start. See
