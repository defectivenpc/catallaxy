...
let
  ...
  certManagerFloe = import ../cluster/cert-manager;
  certManagerArgs = {
    args = {
      inherit pkgs;
  ...
  gatewayFloe = import ../cluster/gateway;
  gatewayArgs = {
    args = {
      inherit pkgs;
      cataCharts.traefik = {
  ...
  lokiCfg = disabled (simpleCharts "loki") (import ../cluster/loki) {
    floes.loki.enable = false;
  };
  prometheusCfg = disabled (simpleCharts "prometheus") (import ../cluster/prometheus) {
    imports = [
      (
        { lib, ... }:
        {
  ...
  tempoCfg = disabled (simpleCharts "tempo") (import ../cluster/tempo) {
